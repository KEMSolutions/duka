...
return [
    ...
    */
    ...
    "error_persist" =>" Si l'erreur persiste, contactez-nous pour communiquer avec un agent!",
    ...
    "product_usage" => "Usage",
    "product_warning"=> "Avertissement d'utilisation",
    ...
    "canadian_shipping" =>"Expédié de notre entrepôt au Canada",
    "world_shipping"    =>"Disponible à la livraison internationale",
