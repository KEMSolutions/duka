...
return [
    ...
    */
    ...
    'search_in'     =>'Search in: ',
    'handpick'      =>'Our hand picked selection for you.',
    ...
    "error_persist" =>"If the error persists, contact us to talk to an agent!",
    ...
    "show_less"     =>"Show less",
    "featured"      =>"Featured",
    "create_account"=>"Create an account to keep track of your purchases!",
    "simple_easy"   =>"It is simple and easy.",
    ...
    "canadian_shipping" =>"Shipped from our canadian warehouse",
    "world_shipping"    =>"Worldwide Shipping Available",
    ...
    "suggested_product" =>"People also bought:",
