...
return [
    ...
    */
    ...
    "error"=>"Sorry, but an error has been made.",
    ...
    "shortcuts"     =>"Shortcuts",
    "customer_serv" =>"Customer Service",
    ...
    "password"      =>"Password",
    "create_pass"   =>"Save this password",
    "account"       =>"Account",
    ...
    "contact_email"     => "If you encounter a problem, you can always contact us at <a href=mailto: :name>:name</a> or :name.",
    ...
    "name_recommandation"=>":name's recommendation",
