...
var productFormatContainer = {
    ...
    productWithFormat: function(option) {
        if (option.find(":selected").data("reduced") != "undef") {
            var price = '<span id="product-format-name">' +
                ...
                ' CAD $ ' + option.find(":selected").data("price").toFixed(2) +
                '</span>' +
    ...
    productWithoutFormat: function(option) {
        ...
        $("#product-price").text("CAD $ " + option.find(":selected").data("price").toFixed(2));
    },
    ...
    updateBuybuttonAttributes: function (option) {
        $(".buybutton").attr({
            ...
            'data-price': option.find(":selected").data("reduced") === "undef" ? option.find(":selected").data("price").toFixed(2) : option.find(":selected").data("reduced"),
